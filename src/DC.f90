...
!	if(rank.eq.0) write(*,*)'FILTERING DATA WITH BANDPASS BETWEEN ', f1,' Hz AND ',f2,' Hz'
!	call time_filter(input,nt,dt,nSS,f1,f2)

	if(rank.eq.0)write(*,*)'SAVING FILTERED INPUT ...'
	call WRITE_INPUT(iOBS,nSS,input)

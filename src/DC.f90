...
subroutine DC_function(iDC,iOBS,rank,datum_i,datum_f)
...
integer :: i,j,k,iDC,nSS,iOBS,rank
...
call READ_DATA(iOBS,unit0,nSS,input)
...
call DC_propagation(iDC,nSS,datum_i,datum_f,pos_shot_grid,input,output)
...
call WRITE_OUTPUT(iDC,iOBS,nSS,output)
